...
module.exports.placeBid = asyncHandler(async (req, res) => {
  ...
  if (product.user.toString() === userId.toString()) {
    return res.status(403).json({ message: "You cannot place a bid on your own product" });
  }
...
const emailTemplate = `
  <div style="font-family: Arial, sans-serif; line-height: 1.5; color: #333;">
    ...
    <div style="padding: 20px;">
      ...
      <h2 style="font-size: 24px; color: #4CAF50; text-align: center;"><b>$${finalPrice.toFixed(2)}</b></h2>
